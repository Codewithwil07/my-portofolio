            ...
            <div className='grid grid-cols-2 gap-x-10 gap-y-5 py-16 md:grid-cols-3 xl:grid-cols-4'>
                ...
                <div>
                    ...
                    <p className='text-gray-400 text-sm md:text-base'>
                        ...
                        <br />
                        Javascript is a high-level end dynamic programming
                        language
                    </p>
                </div>
                <div>
                    ...
                    <p className='text-gray-400 text-sm md:text-base'>
                        ...
                        flex, pt-8, text-center, and rotate-45 than can be
                ...
                <div>
                    ...
                    <p className='text-gray-400 text-sm md:text-base'>
                        ...
                        thats build on Javascript, giving you better tooling at
                        any scale
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p className='text-gray-400 text-sm md:text-base'>
                        ...
                        component-based interactive user interfaces
                    </p>
                </div>
                <div>
                    <img
